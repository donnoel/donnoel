...
- [**Beam**](https://github.com/donnoel/beamscreens) — a local-first Raspberry Pi digital signage system built around reliable playback, recovery, and clear operations. [Project page](https://donnoel.github.io/beamscreens/)
