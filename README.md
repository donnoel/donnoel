...
### Private tools and workflow projects
- **Loom** — a local-first macOS workspace for experimenting with local LLM workflows.
- **Project Pilot** — a macOS utility for generating new Xcode projects from a known-good template.
